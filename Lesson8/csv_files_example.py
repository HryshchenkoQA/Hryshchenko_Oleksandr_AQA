...
# #     birthday_writer = csv.writer(birthday, delimiter = ',')#, quatechar = "'")
# #     birthday_writer.writerow(['Markus', 'python', '2'])
# #     birthday_writer.writerow(['Alex,', 'C++', '4'])
#
with open('birthday3.csv', 'w') as birthday:
    ...
    # birthday_dict_writer.writerow({'name':'Boris', 'group':'english',"birthday":'10'})day': 8}, {'name': 'Boris', 'group': 'english', 'birthday': 10}])